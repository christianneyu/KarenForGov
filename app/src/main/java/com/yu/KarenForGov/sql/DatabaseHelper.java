package com.yu.KarenForGov.sql;
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setInterest(cursor.getString(cursor.getColumnIndex(COLUMN_USER_INTEREST)));
...
//        SQLiteDatabase db = this.getReadableDatabase();
//        // selection criteria
//        String selection = COLUMN_USER_EMAIL + " = ?" + " AND " + COLUMN_USER_INTEREST + " = ?";
//
//        // selection arguments
